...
PLAYLIST_URL = "https://gitlab.com/josieljefferson12/playlists/-/raw/main/PiauiTV.m3u"
EPG_URL = "http://m3u4u.com/epg/jq2zy9epr3bwxmgwyxr5"

# Configurações do GitHub
GITHUB_REPO = os.getenv("GITHUB_REPO", "josieljefferson12/iMPlayer")
GITHUB_TOKEN = os.getenv("MY_GITHUB_TOKEN")  # Nome correto do segredo no GitHub Actions
GITHUB_BRANCH = os.getenv("GITHUB_BRANCH", "main")
OUTPUT_FILE = "adultos.epg.xml"
...
def push_to_github(file_content, file_name):
    ...
    repo.index.commit(f"Atualização automática do EPG em {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
...
if __name__ == "__main__":
    try:
        ...
        playlist = download_file(PLAYLIST_URL, "adultos2.m3u")
        epg_xml = download_file(EPG_URL, "adultos.epg.xml")
